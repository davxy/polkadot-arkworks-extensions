...
use ark_scale::ark_serialize::{CanonicalSerialize, Compress};
...
pub fn make_mul_affine_args<Affine: UniformRand>() -> (ArkScale<Affine>, ArkScale<Vec<u64>>) {
    (make_base::<Affine>().into(), make_scalar(4).into())
}
